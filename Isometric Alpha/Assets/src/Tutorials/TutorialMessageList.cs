...
public static class TutorialMessageList
{
    ...
    private static void instantiateTutorialMessageList()
    {
        ...
        tutorialDictionary.Add(hostileTargetTutorialMessagePrefix + 1, "There is a creature in your path. Press ' " + keyCodePlaceHolder + " ' to highlight it.");
        tutorialDictionary.Add(hostileTargetTutorialMessagePrefix + 2, "The creature is highlighted in red. This means it is a hostile creature. Press ' " + keyCodePlaceHolder + " ' again to remove the highlight.");
        ...
        tutorialDictionary.Add(hostileTargetTutorialMessagePrefix + 6, "Press ' " + keyCodePlaceHolder + " ' to move next to the creature and start combat.");
        ...
        tutorialDictionary.Add(intimidateTutorialMessagePrefix + 1, "This creature is hiding around a blind corner. The Intimidate skill can keep it from surprising you. Press ' " + keyCodePlaceHolder + " ' to activate it.");
        ...
        tutorialDictionary.Add(intimidateTutorialMessagePrefix + 3, "You have limited uses of Intimidate. These are replenished when you enter a new area. Press ' " + keyCodePlaceHolder + " ' to use Intimidate.");
        tutorialDictionary.Add(intimidateTutorialMessagePrefix + 4, "The symbol above the creature indicates it has been intimidated. Press ' " + keyCodePlaceHolder + " ' to start combat.");

        tutorialDictionary.Add(interactableObjectTutorialMessagePrefix + 1, "Rubble blocks your path. If you highlight interactables, the rubble will be shown in green. This means you can interact with it like you would an NPC. Press ' " + keyCodePlaceHolder + " ' to interact with it.");
        tutorialDictionary.Add(interactableObjectTutorialMessagePrefix + 2, "Barrels block your path. If you highlight interactables, the barrels will be shown in green. This means you can interact with them like you would an NPC. Press ' " + keyCodePlaceHolder + " ' to interact with it.");


        tutorialDictionary.Add(cunningTutorialMessagePrefix + 1, "This creature is hiding around a blind corner. This is a good opportunity to use the Cunning skill. Press ' " + keyCodePlaceHolder + " ' to begin to activate the Cunning Skill.");
        tutorialDictionary.Add(cunningTutorialMessagePrefix + 2, "The yellow tiles show the Cunning skill's range. A red tile shows a target. You are currently targeting the green tile. Use the Movement keys to change the tile you are targeting. Press ' " + keyCodePlaceHolder + " ' to target the creature.");
        tutorialDictionary.Add(cunningTutorialMessagePrefix + 3, "You are now targeting the creature. Press ' " + keyCodePlaceHolder + " ' to use Cunning on the creature.");
        tutorialDictionary.Add(cunningTutorialMessagePrefix + 4, "The symbol above the creature indicates it has been distracted. Press ' " + keyCodePlaceHolder + " ' to start combat.");

        tutorialDictionary.Add(cunningTutorialMessagePrefix + 5, "Some obstacles can be activated with Cunning. Cunning targets have a yellow border when you highlight interactables. Press ' " + keyCodePlaceHolder + " ' to begin to activate the Cunning Skill again.");
        ...
        tutorialDictionary.Add(observationTutorialMessagePrefix + 5, "Now press ' " + keyCodePlaceHolder + " ' to walk up to the secret door.");
        tutorialDictionary.Add(observationTutorialMessagePrefix + 6, "Press ' " + keyCodePlaceHolder + " ' to interact.");

        tutorialDictionary.Add(leadershipTutorialMessagePrefix + 1, "Your path is blocked. Some obstacles can be removed by pressing buttons. Press ' " + keyCodePlaceHolder + " ' to move on to the button.");
        ...
        tutorialDictionary.Add(leadershipTutorialMessagePrefix + 3, "Press ' " + keyCodePlaceHolder + " ' to place a follower.");
        tutorialDictionary.Add(leadershipTutorialMessagePrefix + 4, "You follower has been placed. Press ' " + keyCodePlaceHolder + " ' to move off of the button and reveal your follower.");
        tutorialDictionary.Add(leadershipTutorialMessagePrefix + 5, "Your follower is now holding down the first button. You can't move through placed followers, but neither can enemies. Remove followers by pressing ' " + keyCodePlaceHolder + " ' while facing them.");
        tutorialDictionary.Add(leadershipTutorialMessagePrefix + 6, "Press ' " + keyCodePlaceHolder + " ' to move to the second button.");

        tutorialDictionary.Add(equippableItemTutorialMessagePrefix + 1, "You have been given some equipment. Click the Inventory button, or press ' " + keyCodePlaceHolder + " '.");
        ...
        tutorialDictionary.Add(formationPopUpTutorialMessagePrefix + 5, "The companion has been added to your formation. To remove a companion, click it's square. When finished, click ' " + keyCodePlaceHolder + " ' or press ' " + keyCodePlaceHolder + " '.");

        tutorialDictionary.Add(hiddenObjectTutorialMessagePrefix + 1, "Bálint has asked for you to gather leaves in this area. Sometimes, quest objectives and other important objects are hidden behind terrain. Press ' " + keyCodePlaceHolder + " ' to remove the tops of buildings and scenery to get a better look behind them.");
        ...
        tutorialDictionary.Add(playerLevelUpTutorialMessagePrefix + 1, "You have gained enough Experience to Level Up. Press ' " + keyCodePlaceHolder + " ' or click the Character screen button.");
        ...
        tutorialDictionary.Add(combatTutorialMessagePrefix + 4 + " EnemyGetsSurpriseRound", "The Surprise Round Icon is red, meaning you have been surprised. When you are surprised, you forfeit your first turn. Press ' " + keyCodePlaceHolder + " ' to let the enemy take their turn.");
        ...
        tutorialDictionary.Add(combatTutorialRepositionMessagePrefix + 1, "Notice the indicator has turned yellow. This means the Action you've chosen allows you to choose a secondary target. Use the Movement keys to position the selector and choose the second location with ' " + keyCodePlaceHolder + " '.");
