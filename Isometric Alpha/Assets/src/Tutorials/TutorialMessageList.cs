...
public static class TutorialMessageList
{
    ...
    private static void instantiateTutorialMessageList()
    {
        ...
        tutorialDictionary.Add(intimidateTutorialMessagePrefix + 1, "This creature is hiding around a blind corner. The Intimidate skill can keep it from surprising you. Press <nobr>' " + keyCodePlaceHolder + " '</nobr> to activate it.");
        ...
        tutorialDictionary.Add(cunningTutorialMessagePrefix + 5, "Some obstacles can be activated with Cunning. Cunning targets have a yellow border when you highlight interactables. Press <nobr>' " + keyCodePlaceHolder + " '</nobr> to begin to activate the Cunning Skill again.");
        ...
        tutorialDictionary.Add(observationTutorialMessagePrefix + 1, "Your path is blocked by a hidden door. Hidden doors are not highlighted by pressing ' " + revealKeyCodePlaceHolder + " '. Instead, use the Observation skill to reveal them. Press <nobr>' " + keyCodePlaceHolder + " '</nobr> to face the door.");
        ...
        tutorialDictionary.Add(leadershipTutorialMessagePrefix + 1, "Your path is blocked. Some obstacles can be removed by pressing buttons. Press <nobr>' " + keyCodePlaceHolder + " '</nobr> to move on to the button.");
