...
public static class SpawnInfoManager
{
    ...
    private static List<GameObject> spawnBackground()
    {
        ...
        GameObject background = GameObject.Instantiate(Resources.Load<GameObject>(AreaManager.locationName + backgroundSuffix), AreaManager.getGridParent());
    ...
    {
        List<Transition> transitionList = TransitionSpawnInfoList.getTransitionSpawnInfo(AreaManager.locationName);
        List<GameObject> spawnedObjects = new List<GameObject>();
