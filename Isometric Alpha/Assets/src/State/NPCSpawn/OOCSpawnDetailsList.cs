...
public static class OOCSpawnDetailsList
{
    ...
    private static void initializeSpawnDetailsList()
    {
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.balint, new Vector3Int(7, 1), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(NPCNameList.seb, new Vector3Int(6, 5), animationType: CharacterAnimationType.Death_Front_Weaponless));

        oocSpawnDetailsDict.Add(LocationNameList.slaveShackOne, list);
        #endregion
        #region 2SlaveShack
        list = new List<OOCSpawnDetails>();
        list.Add(new NPCSpawnDetails(NPCNameList.brush, new Vector3Int(4, 2), facing: Facing.SouthEast, speakAtStartScript: new BeginningConversationScript()));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.kastor, new Vector3Int(11, 13), facing: Facing.SouthWest));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.dezso, new Vector3Int(6, 6), facing: Facing.SouthWest, speakAtStartScript: new DezsoLoamDialogueScript()));
        list.Add(new NPCSpawnDetails(NPCNameList.loam, new Vector3Int(5, 9), facing: Facing.SouthEast));

        list.Add(new NPCSpawnDetails(NPCNameList.slave, new Vector3Int(9, 9), facing: Facing.SouthWest, ignoresSecretDoors: false));
        list.Add(new NPCSpawnDetails(NPCNameList.slave, new Vector3Int(3, 3)/*, animationName: NPCNameList.slave+1*/, facing: Facing.NorthWest, ignoresSecretDoors: false));
        list.Add(new NPCSpawnDetails(NPCNameList.slave, new Vector3Int(7, 12)/*, animationName: NPCNameList.slave+2*/, facing: Facing.SouthEast, ignoresSecretDoors: false));
        list.Add(new NPCSpawnDetails(NPCNameList.slave, new Vector3Int(7, 3)/*, animationName: NPCNameList.temple*/, facing: Facing.SouthWest, ignoresSecretDoors: false));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.weft, new Vector3Int(3, -5), facing: Facing.NorthWest, speakAtStartScript: new WeftIntroScript()));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.uros, new Vector3Int(7, -1), facing: Facing.SouthEast));
        ...
        list.Add(new ObstacleWithSecretDoorFlagSpawnDetails(NPCNameList.unseenBarrier, new Vector3Int(-2, 2), secretDoorFlag: SecretDoorKeyList.bodyPilePool, appearance: SpriteDescriptionList.unseenBarrier));
        list.Add(new ObstacleWithSecretDoorFlagSpawnDetails(NPCNameList.unseenBarrier, new Vector3Int(-3, 1), secretDoorFlag: SecretDoorKeyList.bodyPilePool, appearance: SpriteDescriptionList.unseenBarrier));
        list.Add(new ObstacleWithSecretDoorFlagSpawnDetails(NPCNameList.unseenBarrier, new Vector3Int(-5, -1), secretDoorFlag: SecretDoorKeyList.bodyPilePool, appearance: SpriteDescriptionList.unseenBarrier));
        list.Add(new ObstacleWithSecretDoorFlagSpawnDetails(NPCNameList.unseenBarrier, new Vector3Int(-6, -2), secretDoorFlag: SecretDoorKeyList.bodyPilePool, appearance: SpriteDescriptionList.unseenBarrier));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.chiefTabor, new Vector3Int(-8, -9), facing: Facing.SouthWest));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.leafPile, new Vector3Int(18, -7), appearance: SpriteDescriptionList.leafPile));
        list.Add(new NPCSpawnDetails(NPCNameList.leafPile, new Vector3Int(17, -8), appearance: SpriteDescriptionList.leafPile));
        ...
        list.Add(new NPCSpawnDetails(MonsterNameList.brandedConscript, new Vector3Int(-3, 5), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.brandedConscript, new Vector3Int(-6, 4), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.spearman, new Vector3Int(-2, 4), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.brandedConscript, new Vector3Int(-4, 3), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.brandedConscript, new Vector3Int(-2, 2), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.brandedConscript, new Vector3Int(-4, 1), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.brandedConscript, new Vector3Int(-4, -1), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.brandedConscript, new Vector3Int(-6, -1), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.spearman, new Vector3Int(-2, -2), facing: Facing.SouthWest));
        list.Add(new NPCSpawnDetails(MonsterNameList.brandedConscript, new Vector3Int(-5, -4), facing: Facing.SouthWest));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.gateGuard, new Vector3Int(3, -18)/*, animationName: MonsterNameList.executioner*/, facing: Facing.SouthEast));
        list.Add(new NPCSpawnDetails(NPCNameList.gateGuard, new Vector3Int(0, -18)/*, animationName: MonsterNameList.lancer*/, facing: Facing.SouthEast));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.page, new Vector3Int(5, 0), facing: Facing.SouthEast));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.toppledStatue, new Vector3Int(7, 3),
                                    extraSpaces: new Vector3Int[] {
                                                        new Vector3Int(7, 4),
                                                        new Vector3Int(8, 4),
                                                        new Vector3Int(8, 3)
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.marcos, new Vector3Int(9, -5), facing: Facing.SouthEast, animationType: CharacterAnimationType.Secondary_Idle, ignoresSecretDoors: false));
        list.Add(new NPCSpawnDetails(NPCNameList.reka, new Vector3Int(7, -5), facing: Facing.SouthEast, animationType: CharacterAnimationType.Secondary_Idle, ignoresSecretDoors: false));
        list.Add(new NPCSpawnDetails(NPCNameList.andras, new Vector3Int(5, -5), facing: Facing.SouthEast, animationType: CharacterAnimationType.Secondary_Idle, ignoresSecretDoors: false));
        list.Add(new NPCSpawnDetails(NPCNameList.pazman, new Vector3Int(3, -5), facing: Facing.SouthEast, animationType: CharacterAnimationType.Secondary_Idle, ignoresSecretDoors: false));
        list.Add(new NPCSpawnDetails(NPCNameList.chiefTabor, new Vector3Int(1, -5), facing: Facing.SouthEast, animationType: CharacterAnimationType.Secondary_Idle, ignoresSecretDoors: false));

        list.Add(new NPCSpawnDetails(NPCNameList.géza, new Vector3Int(6, -11), facing: Facing.NorthWest));
        list.Add(new NPCSpawnDetails(NPCNameList.brush, new Vector3Int(5, -11), facing: Facing.NorthWest));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.chiefTabor, new Vector3Int(-7, -1), facing: Facing.SouthWest));
        ...
        list.Add(new VaultableObjectSpawnDetails(NPCNameList.vaultableRocks, new Vector3Int(8, 7), VaultableObject.diffTwoSizeTwoVaultableRocks, appearance: SpriteDescriptionList.vaultableRocks));
        list.Add(new VaultableObjectSpawnDetails(NPCNameList.vaultableRocks, new Vector3Int(7, 7), VaultableObject.diffTwoSizeTwoVaultableRocks, appearance: SpriteDescriptionList.vaultableRocks));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.guardReka, new Vector3Int(3, 9), facing: Facing.SouthWest));

        list.Add(new NPCSpawnDetails(NPCNameList.guardVirag, new Vector3Int(3, 6), facing: Facing.SouthWest));
        ...
        list.Add(new VaultableObjectSpawnDetails(NPCNameList.vaultableRocks, new Vector3Int(0, 1), new VaultableObject(Constants.difficultyTwo, Constants.sizeFour, VaultableObject.isPlural, VaultableObject.rockName), appearance: SpriteDescriptionList.vaultableRocks));
        list.Add(new VaultableObjectSpawnDetails(NPCNameList.vaultableRocks, new Vector3Int(-1, 1), new VaultableObject(Constants.difficultyTwo, Constants.sizeFour, VaultableObject.isPlural, VaultableObject.rockName), appearance: SpriteDescriptionList.vaultableRocks));
        list.Add(new VaultableObjectSpawnDetails(NPCNameList.vaultableRocks, new Vector3Int(0, -2), new VaultableObject(Constants.difficultyTwo, Constants.sizeFour, VaultableObject.isPlural, VaultableObject.rockName), appearance: SpriteDescriptionList.vaultableRocks));
        list.Add(new VaultableObjectSpawnDetails(NPCNameList.vaultableRocks, new Vector3Int(-1, -2), new VaultableObject(Constants.difficultyTwo, Constants.sizeFour, VaultableObject.isPlural, VaultableObject.rockName), appearance: SpriteDescriptionList.vaultableRocks));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.barricade, new Vector3Int(5, 11), facing: Facing.NorthWest));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.guardVirag, new Vector3Int(4, 5), facing: Facing.NorthWest));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.barricade, new Vector3Int(3, 3), facing: Facing.NorthWest));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.nandor, new Vector3Int(4, 1), facing: Facing.SouthWest));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.rubble, new Vector3Int(-6, 10), appearance: SpriteDescriptionList.lowStalagmite));
        list.Add(new NPCSpawnDetails(NPCNameList.rubble, new Vector3Int(-7, 10), appearance: SpriteDescriptionList.lowStalagmite));
        ...
        list.Add(new NPCSpawnDetails(NPCNameList.beam, new Vector3Int(3, 9), facing: Facing.SouthEast, speakAtStartScript: new BeamAndCsalanInManseScript()));

        list.Add(new HorseSpawnDetails(NPCNameList.csalan, new Vector3Int(5, 8), Facing.SouthEast)); 
