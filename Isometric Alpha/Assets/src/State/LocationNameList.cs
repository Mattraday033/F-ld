...
public static class LocationNameList
{
    ...
    public const string campInterior = "CampInterior";
    ...
    public const string campExterior = "CampExterior";

    public const string campNorthEast = "NECamp";
    public const string campCenter = "CenterCamp";
    public const string campManse = "ManseCamp";
    public const string campSouthEast = "SECamp";
    public const string campMineEntrance = "MineEntranceCamp";
    #endregion
