...
public static class EnemyTypeFolderPathList
{
    ...
    public static void initializeEnemyTypeFolderPathList()
    {
        ...
        folderPathDict.Add(MonsterNameList.direGuardianWorm, wormFolderPath + MonsterNameList.direGuardianWorm + "/");
        ...
        folderPathDict.Add(NPCNameList.dibber, brandedFolderPath + MonsterNameList.brandedRioter + MonsterNameList.pickMarker + "/");
        folderPathDict.Add(NPCNameList.dezso, brandedFolderPath + NPCNameList.dezso + "/");
        ...
        folderPathDict.Add(NPCNameList.loam, brandedFolderPath + NPCNameList.loam + "/");
    ...
    public static Sprite getHeadSprite(string enemyType)
    {
        ...
        return SpriteUtil.loadSpriteFromResources(getEnemyTypeFolderPath(enemyType) + PrefabNames.headsSpriteName);
    }
