...
public static class QuestNameList
{
    ...
    public const string dealWithThePrisonersStepTitleTwo = "Recompense, finally.";
    public const string dealWithThePrisonersStepTitleThree = "Márcos, free.";
    public const string dealWithThePrisonersStepTitleFour = "Márcos, punished.";
    public const string dealWithThePrisonersStepTitleFive = "Márcos, executed.";
    public const string dealWithThePrisonersStepTitleSix = "Márcos, mobbed.";
    public const string dealWithThePrisonersStepTitleSeven = "András, free.";
    public const string dealWithThePrisonersStepTitleEight = "András, punished.";
    public const string dealWithThePrisonersStepTitleNine = "András, executed.";
    public const string dealWithThePrisonersStepTitleTen = "András, mobbed.";
    public const string dealWithThePrisonersStepTitleEleven = "Réka, free.";
    public const string dealWithThePrisonersStepTitleTwelve = "Réka, punished.";
    public const string dealWithThePrisonersStepTitleThirteen = "Réka, executed.";
    public const string dealWithThePrisonersStepTitleFourteen = "Réka, mobbed.";
    public const string dealWithThePrisonersStepTitleFifteen = "Pázmán, free.";
    public const string dealWithThePrisonersStepTitleSixteen = "Pázmán, punished.";
    public const string dealWithThePrisonersStepTitleSeventeen = "Pázmán, executed.";
    public const string dealWithThePrisonersStepTitleEighteen = "Pázmán, mobbed.";
