...
public static class ItemList 
{
	...
	private static void initializeItemList()
	{
        ...
        usableItems.Add(new HealingItem(new ItemListID(usableItemListIndex, rockCakeIndex), "Rock Cake", "A brittle roll that looks like a grey stone. Surprisingly, it appears to still be edible.", ItemSpriteList.rockCakeSprite, 8, rockCakeHealingAmount, AudioClipList.getDialogueIntroSFXLogic(ItemSpriteList.rockCakeSprite)));
