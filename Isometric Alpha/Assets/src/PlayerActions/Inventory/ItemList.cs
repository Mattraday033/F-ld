...
public static class ItemList 
{
	...
	private static void initializeItemList()
	{
		...
		weapons.Add(new Weapon(new ItemListID(weaponsListIndex, wickedKnifeIndex), "Wicked Knife", "A barbed knife, meant for gouging.", "2D + 3", "2D + 1", "WickedKnife", Range.singleTargetIndex, 15, Weapon.offHandSlotIndex, isOneHanded));
