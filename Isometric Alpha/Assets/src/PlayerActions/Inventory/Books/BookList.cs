		...
		switch (key)
		{
			...
			case guideToSkillsKey:
				return "Skills are Abilities that are usable outside of Combat. A Party Member unlocks a Skill by having a 2 or higher in that Skill's corresponding Primary Stat. The four Skills are Intimidate (Strength), Cunning (Dexterity), Observation (Wisdom), " + 
                        ...
                        "Some Skills require Skill Charges to use." + Constants.skillChargeDescription + "\n\n" +
                        ...
                        "All Enemies within the target area will be Intimidated. Using Intimidate in this way costs two charges, regardless of how many packs of Enemies were affected. " + 
                        "Intimidate can also be used to scare Shopkeepers into providing a discount on sold goods. Scaring Shopkeepers only costs a single charge, but will raise the Hostility of the current Area.\n\n" + 
                        ...
                        "Distracting an Enemy costs two charges of Cunning. Cunning can also be used to activate certain objects in the Overworld. If Cunning can be used on an object, then that object will have a yellow " + 
