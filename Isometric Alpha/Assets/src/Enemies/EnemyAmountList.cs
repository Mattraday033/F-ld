...
public static class EnemyAmountList
{
    ...
    public readonly static CreatureAmount chiefTabor = new CreatureAmount(Constants.oneCreature, EnemyStatsList.getEnemyStats(NPCNameList.chiefTabor));
    public readonly static CreatureAmount captainAdela = new CreatureAmount(Constants.oneCreature, EnemyStatsList.getEnemyStats(NPCNameList.captainAdela));
    ...
    public readonly static CreatureAmount axemanPuppets = new CreatureAmount(Constants.fourCreatures, EnemyStatsList.getEnemyStats(MonsterNameList.puppetedPrefix + MonsterNameList.axeman));
    public readonly static CreatureAmount spearmanPuppets = new CreatureAmount(Constants.fourCreatures, EnemyStatsList.getEnemyStats(MonsterNameList.puppetedPrefix + MonsterNameList.spearman));
    public readonly static CreatureAmount disciplinarianPuppets = new CreatureAmount(Constants.fourCreatures, EnemyStatsList.getEnemyStats(MonsterNameList.puppetedPrefix + MonsterNameList.disciplinarian));
    public readonly static CreatureAmount javelineerPuppets = new CreatureAmount(Constants.fourCreatures, EnemyStatsList.getEnemyStats(MonsterNameList.puppetedPrefix + MonsterNameList.javelineer));
