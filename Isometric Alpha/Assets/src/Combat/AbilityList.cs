...
public static class AbilityList
{
	...
	private static void instantiateEnemyAbilities()
	{
		...
		//bat abilities
		enemyAbilityDictionary.Add(flurryKey, new Ability(CombatActionSettings.build(DescriptionParams.build(flurryKey, "A devastating surge of claws and jaws."), DamageParams.build("12", "6"), TargetParams.build(Range.boxOneIndex), AnimationParams.build(EffectAnimationType.BatSwarm))));
        enemyAbilityDictionary.Add(screechKey, new Ability(CombatActionSettings.build(DescriptionParams.build(screechKey, "A howl so loud it draws blood.", StatSourceNameList.caveMadnessKey), DamageParams.build("10", "2"), TargetParams.build(Range.boxOneIndex), TraitList.caveMadness)));
        ...
        enemyAbilityDictionary.Add(guardSpearKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardSpearKey, "A piercing blow capable of skewering multiple foes."), DamageParams.build("13", "4"), TargetParams.build(Range.verticalOneIndex), AnimationParams.build(EffectAnimationType.Pierce))));
        enemyAbilityDictionary.Add(guardAxeKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardAxeKey, "A wide sweep from a sharp axe."), DamageParams.build("11", "10"), TargetParams.build(Range.horizontalTwoIndex))));
        enemyAbilityDictionary.Add(guardArrowBarrageKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardArrowBarrageKey, "A hail of deadly missles called from nearby arrow towers."), DamageParams.build("16", "15"))));
        enemyAbilityDictionary.Add(guardJavelinKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardJavelinKey, "A missile aimed right at your heart."), DamageParams.build("8", "5"), TargetParams.build(Range.verticalOneIndex))));
        enemyAbilityDictionary.Add(guardLashKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardLashKey, "The bane of slaves everywhere.", "Lashings"), DamageParams.build("10", "40"), TargetParams.build(Range.verticalThreeIndex))));
        ...
        enemyAbilityDictionary.Add(eviscerateKey, new BacklashAbility(CombatActionSettings.build(DescriptionParams.build(eviscerateKey, "A devastating cut capable of unseaming an enemy. This attack hurts the attacker as well as the target.", "MakeItBleed"), DamageParams.build("20", "5"), TargetParams.build(Range.boxOneIndex), TraitList.wounded), oneHundredPercentBacklash));
        enemyAbilityDictionary.Add(skullBashKey, new Ability(CombatActionSettings.build(DescriptionParams.build(skullBashKey, "A blow to the temple that disorients the target.", "Upside the Head"), DamageParams.build("8", "10"), TargetParams.build(Range.verticalOneIndex), TraitList.upsideTheHead)));
        enemyAbilityDictionary.Add(squadStrikeKey, new SquadAbility(CombatActionSettings.build(DescriptionParams.build(squadStrikeKey, "An attack that utilizes the cooperation of other squad members. Deals more damage if the attacker is adjacent to one or more allies."), DamageParams.build("5", "5"), TargetParams.build(Range.boxOneIndex)), "22"));
        enemyAbilityDictionary.Add(skewerKey, new Ability(CombatActionSettings.build(DescriptionParams.build(skewerKey, "The lancer pierces multiple targets in a row."), DamageParams.build("21", "10"), TargetParams.build(Range.verticalThreeIndex), AnimationParams.build(EffectAnimationType.Pierce))));
        enemyAbilityDictionary.Add(executeKey, new Ability(CombatActionSettings.build(DescriptionParams.build(executeKey, "A chop so quick, it may very well be the last thing you ever see."), DamageParams.build("18", "50"), TargetParams.build(Range.horizontalThreeIndex))));
        ...
        enemyAbilityDictionary.Add(shatterKey, new Ability(CombatActionSettings.build(DescriptionParams.build(shatterKey, "A destructive strike with an enormous area."), DamageParams.build("25", "5"), TargetParams.build(Range.boxTwoIndex), AnimationParams.build(EffectAnimationType.Blunt))));
		...
		//Horse Abilities
		enemyAbilityDictionary.Add(chargeKey, new Ability(CombatActionSettings.build(DescriptionParams.build(chargeKey, "The creature rushes headlong at it's foe, crushing them underfoot."), DamageParams.build("10", "6"), TargetParams.build(Range.verticalThreeIndex), AnimationParams.build(EffectAnimationType.Blunt))));
