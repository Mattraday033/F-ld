...
public static class AbilityList
{
	...
	private static void instantiateEnemyAbilities()
	{
        ...
        enemyAbilityDictionary.Add(squadStrikeKey, new SquadAbility(CombatActionSettings.build(DescriptionParams.build(squadStrikeKey, iconName: squadStrikeKey, useDescription: "Deals more damage if the attacker is adjacent to one or more allies."), DamageParams.build("10", "5"), TargetParams.build(SelectorList.boxOneName)), "31"));
