...
public static class AbilityList
{
	...
	private static void instantiateEnemyAbilities()
	{
        ...
        //generic abilities
        enemyAbilityDictionary.Add(harmlessKey, new Ability(CombatActionSettings.build(DescriptionParams.build(harmlessKey, useDescription: "This creature takes no actions."), DamageParams.build("0", "0"), TargetParams.build(SelectorTemplate.Single))));
		enemyAbilityDictionary.Add(punchKey, new Ability(CombatActionSettings.build(DescriptionParams.build(punchKey, iconName: "FistIcon", loreDescription: "A punch. Not much to it."), DamageParams.build("3", "2"), TargetParams.build(SelectorTemplate.Single))));
        ...
        enemyAbilityDictionary.Add(gutKey, new Ability(CombatActionSettings.build(gutKey, DescriptionParams.build(gutKey, loreDescription: "A knife in the stomach that leaves lasting damage."), DamageParams.build("45", "15"), TargetParams.build(SelectorTemplate.Single), animationParams: AnimationParams.build(EffectAnimationType.Pierce), appliedTrait: TraitList.wounded)));
        enemyAbilityDictionary.Add(rileKey, new Ability(CombatActionSettings.build(rileKey, DescriptionParams.build(rileKey, loreDescription: "Agitate your allies, increasing their furiosity."), targetParams: TargetParams.build(SelectorTemplate.BoxThree), appliedTrait: TraitList.riled)));
        enemyAbilityDictionary.Add(brandedVolleyKey, new Ability(CombatActionSettings.build(DescriptionParams.build(brandedVolleyKey, loreDescription: "The thrown projectiles of an angry mob."), DamageParams.build("25", "20"), TargetParams.build(SelectorTemplate.VerticalOne))));
		...
		//bat abilities
		enemyAbilityDictionary.Add(flurryKey, new Ability(CombatActionSettings.build(DescriptionParams.build(flurryKey, loreDescription: "A devastating surge of claws and jaws."), DamageParams.build("18", "12"), TargetParams.build(SelectorTemplate.BoxOne), animationParams: AnimationParams.build(EffectAnimationType.BatSwarm))));
        enemyAbilityDictionary.Add(screechKey, new Ability(CombatActionSettings.build(DescriptionParams.build(screechKey, iconName: StatSourceNameList.caveMadnessKey, loreDescription: "A howl so loud it draws blood."), DamageParams.build("15", "8"), TargetParams.build(SelectorTemplate.BoxOne), appliedTrait: TraitList.caveMadness)));
        ...
        enemyAbilityDictionary.Add(diveBombKey, new SuicideAbility(CombatActionSettings.build(DescriptionParams.build(diveBombKey, iconName: "DiveBomb", loreDescription: "The bat dives straight for an enemy at lightning speed and collides with it, spraying everyone close by with viscera and guano."), DamageParams.build("5", "1"), TargetParams.build(SelectorTemplate.BoxOne))));
        ...
        enemyAbilityDictionary.Add(trampleKey, new Ability(CombatActionSettings.build(DescriptionParams.build(trampleKey, loreDescription: "The creature crashes into the target, using the size and weight of it's body to crush it's prey."), DamageParams.build("22", "10"), TargetParams.build(SelectorTemplate.VerticalThree))));
        enemyAbilityDictionary.Add(slamKey, new Ability(CombatActionSettings.build(DescriptionParams.build(slamKey, loreDescription: "The creature crashes into the target, using the size and weight of it's body to crush it's prey."), DamageParams.build("27", "15"), TargetParams.build(SelectorTemplate.BoxOne), animationParams: AnimationParams.build(EffectAnimationType.Blunt), appliedTrait: TraitList.wounded)));
        ...
        enemyAbilityDictionary.Add(splitBossSpawnWormsKey, new SummonAbility(CombatActionSettings.build(DescriptionParams.build(splitBossSpawnWormsKey, useDescription: "The worm splits to spawn two smaller worms."), targetParams: TargetParams.build(SelectorTemplate.HorizontalOne), animationParams: AnimationParams.build(AnimationParams.useSpecialAttack)), twoArmoredWorms, activatesAfterDeath: true));
        ...
        enemyAbilityDictionary.Add(bladeBlitzKey, new Ability(CombatActionSettings.build(DescriptionParams.build(bladeBlitzKey, iconName: executeKey, loreDescription: "Two axe strikes, lightning fast."), DamageParams.build("25", "15"), TargetParams.build(SelectorTemplate.HorizontalTwo))));
        enemyAbilityDictionary.Add(guardSpearKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardSpearKey, loreDescription: "A piercing blow capable of skewering multiple targets."), DamageParams.build("25", "15"), TargetParams.build(SelectorTemplate.VerticalOne), animationParams: AnimationParams.build(EffectAnimationType.Pierce))));
        enemyAbilityDictionary.Add(guardAxeKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardAxeKey, loreDescription: "A wide sweep from a sharp axe."), DamageParams.build("23", "10"), TargetParams.build(SelectorTemplate.HorizontalTwo))));
        ...
        enemyAbilityDictionary.Add(guardJavelinKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardJavelinKey, loreDescription: "A missile aimed right at your heart."), DamageParams.build("17", "5"), TargetParams.build(SelectorTemplate.VerticalOne))));
        enemyAbilityDictionary.Add(guardLashKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardLashKey, iconName: "Lashings", loreDescription: "The bane of slaves everywhere."), DamageParams.build("21", "40"), TargetParams.build(SelectorTemplate.VerticalThree))));
        enemyAbilityDictionary.Add(taborsWhipKey, new Ability(CombatActionSettings.build(DescriptionParams.build(taborsWhipKey, iconName: "Lashings"), DamageParams.build("11", "15"), TargetParams.build(SelectorTemplate.VerticalThree))));
        enemyAbilityDictionary.Add(guardCoordinateKey, new Ability(CombatActionSettings.build(DescriptionParams.build(guardCoordinateKey, iconName: "Cohesion", loreDescription: "A leader takes charge and directs their troops in battle, increasing their damage."), targetParams: TargetParams.build(SelectorTemplate.BoxThree), appliedTrait: TraitList.cohesion)));
        ...
        enemyAbilityDictionary.Add(eviscerateKey, new BacklashAbility(CombatActionSettings.build(DescriptionParams.build(eviscerateKey, iconName: "MakeItBleed", useDescription: "This attack hurts the attacker as well as the target.", loreDescription: "A devastating cut capable of unseaming an enemy."), DamageParams.build("30", "5"), TargetParams.build(SelectorTemplate.BoxOne), appliedTrait: TraitList.wounded), oneHundredPercentBacklash));
        enemyAbilityDictionary.Add(skullBashKey, new Ability(CombatActionSettings.build(DescriptionParams.build(skullBashKey, iconName: "Upside the Head", loreDescription: "A blow to the temple that disorients the target."), DamageParams.build("24", "10"), TargetParams.build(SelectorTemplate.VerticalOne), appliedTrait: TraitList.upsideTheHead)));
        enemyAbilityDictionary.Add(squadStrikeKey, new SquadAbility(CombatActionSettings.build(DescriptionParams.build(squadStrikeKey, iconName: squadStrikeKey, useDescription: "Deals more damage if the attacker is adjacent to one or more allies."), DamageParams.build("10", "5"), TargetParams.build(SelectorTemplate.BoxOne)), "31"));
        enemyAbilityDictionary.Add(skewerKey, new Ability(CombatActionSettings.build(DescriptionParams.build(skewerKey, loreDescription: "The lancer pierces multiple targets in a row."), DamageParams.build("37", "10"), TargetParams.build(SelectorTemplate.VerticalThree), animationParams: AnimationParams.build(EffectAnimationType.Pierce))));
        enemyAbilityDictionary.Add(executeKey, new Ability(CombatActionSettings.build(DescriptionParams.build(executeKey, loreDescription: "A decapitating strike."), DamageParams.build("28", "50"), TargetParams.build(SelectorTemplate.HorizontalThree))));
        enemyAbilityDictionary.Add(turnUpTheHeatKey, new Ability(CombatActionSettings.build(DescriptionParams.build(turnUpTheHeatKey, iconName: "Roasted", loreDescription: "Kende cooks his targets until they're seared on the outside but pink in the middle, making them delectable targets for his allies."), DamageParams.build("12"), TargetParams.build(SelectorTemplate.BoxThree), appliedTrait: TraitList.roasted)));
        enemyAbilityDictionary.Add(shoreUpKey, new MissesArePunishedAbility(CombatActionSettings.build(DescriptionParams.build(shoreUpKey, iconName: shoreUpKey, useDescription: "The Captain bolsters the defenses of her subordinates. If she has a target, she will heal and protect them. If she has no target, she will hurt herself instead."), DamageParams.build("10", "15"),animationParams: AnimationParams.build(useSpecialAttackAnimation: true), appliedTrait: TraitList.shoredUp), missEffectType: EffectAnimationType.Pierce));
        enemyAbilityDictionary.Add(shatterKey, new Ability(CombatActionSettings.build(DescriptionParams.build(shatterKey, loreDescription: "A destructive strike with an enormous area."), DamageParams.build("38", "5"), TargetParams.build(SelectorTemplate.BoxTwo), animationParams: AnimationParams.build(EffectAnimationType.Blunt))));
        enemyAbilityDictionary.Add(frontHandKey, new Ability(CombatActionSettings.build(DescriptionParams.build(frontHandKey, iconName: "Lashings", loreDescription: "A torrent of blows that prevents its targets from attacking."), DamageParams.build("35", "10"), TargetParams.build(SelectorTemplate.VerticalThree), appliedTrait: TraitList.whiplash)));
        enemyAbilityDictionary.Add(backHandKey, new Ability(CombatActionSettings.build(DescriptionParams.build(backHandKey, iconName: "Lashings", loreDescription: "A painful flurry of lashes."), DamageParams.build("25", "50"), TargetParams.build(SelectorTemplate.HorizontalThree), appliedTrait: TraitList.wounded)));
		...
		//Saint Abilities
		enemyAbilityDictionary.Add(boulderRollKey, new Ability(CombatActionSettings.build(DescriptionParams.build(boulderRollKey, iconName: "BoulderRoll", loreDescription: "A massive rock tumbling quickly towards you."), DamageParams.build("31", "10"), TargetParams.build(SelectorTemplate.VerticalThree), animationParams: AnimationParams.build(EffectAnimationType.Blunt))));
        enemyAbilityDictionary.Add(lesserBoulderRollKey, new Ability(CombatActionSettings.build(lesserBoulderRollKey, boulderRollDescription, DamageParams.build("25", "10"), TargetParams.build(SelectorTemplate.VerticalThree), animationParams: AnimationParams.build(EffectAnimationType.Blunt))));
        enemyAbilityDictionary.Add(evolveKey, new EvolveAbility(CombatActionSettings.build(DescriptionParams.build(evolveKey, useDescription: "Evolves targets into more powerful versions of themselves."), targetParams: TargetParams.build(SelectorTemplate.BoxThree)), enemyAbilityDictionary[boulderRollKey]));
	...
	private static void instantiateStatAbilities()
	{
        ...
        currentKey = generateAbilityKey(strengthKeyChar);
        statAbilityDictionary.Add(currentKey, new Ability(CombatActionSettings.build(currentKey, DescriptionParams.build("Power Slam", loreDescription: "A potent assault that hits a wide area."), DamageParams.build("5S + 2D", "2S + D"), TargetParams.build(SelectorTemplate.HorizontalFour), FrequencyParams.build(oneSlotMax, sixRoundCooldown), CostParams.build(ActionCostType.Bloodlust, fourStackCastCost), AnimationParams.build(EffectAnimationType.Blunt))));
        statAbilityDictionary[currentKey].setStatRequirements(currentKey);

        currentKey = generateAbilityKey(strengthKeyChar);
        statAbilityDictionary.Add(currentKey, new Ability(CombatActionSettings.build(currentKey, DescriptionParams.build("Rip Apart", useDescription: "Deals massive damage. If the target survives, they cannot act until the next turn."), DamageParams.build("9S+D+W", "10S"), TargetParams.build(SelectorTemplate.Single), FrequencyParams.build(oneSlotMax, sevenRoundCooldown), CostParams.build(ActionCostType.Bloodlust, fiveStackCastCost), AnimationParams.build(EffectAnimationType.Slash), TraitList.aliveBarely)));
        statAbilityDictionary[currentKey].setStatRequirements(currentKey);

        //start of Dex Abilities
        currentKey = generateAbilityKey(dexterityKeyChar);
        statAbilityDictionary.Add(currentKey, new Ability(CombatActionSettings.build(currentKey, DescriptionParams.build(waylayName, useDescription: "Guaranteed to Crit in the Surprise Round. Waylay has a long Cooldown.", loreDescription: "You strike at the perfect moment, bypassing your opponent's unlevied defenses."), DamageParams.build("5D + S", "2D+5"), TargetParams.build(SelectorTemplate.VerticalThree), FrequencyParams.build(oneSlotMax, nineRoundCooldown), animationParams: AnimationParams.build(EffectAnimationType.Pierce))));
		statAbilityDictionary[currentKey].setStatRequirements(currentKey);
        ...
        currentKey = generateAbilityKey(dexterityKeyChar);
        statAbilityDictionary.Add(currentKey, new DoubleStrikeAbility(CombatActionSettings.build(currentKey, DescriptionParams.build("Twice Slice", useDescription: "You perform two attacks across a large area."), DamageParams.build("4D + 2S", "3D"), TargetParams.build(SelectorTemplate.HorizontalThree), FrequencyParams.build(oneSlotMax, fourRoundCooldown), CostParams.build(ActionCostType.Predation, threeStackCastCost)), SelectorTemplate.VerticalThree));
        statAbilityDictionary[currentKey].setStatRequirements(currentKey);
		...
		currentKey = generateAbilityKey(wisdomKeyChar);
        statAbilityDictionary.Add(currentKey, new Ability(CombatActionSettings.build(currentKey, DescriptionParams.build(crushingBlowName), DamageParams.build("4W + 2S", "W + D"), TargetParams.build(SelectorTemplate.HorizontalTwo), FrequencyParams.build(oneSlotMax, sevenRoundCooldown), CostParams.build(ActionCostType.Stance, fiveStackCastCost), AnimationParams.build(EffectAnimationType.Blunt), TraitList.crushingBlow)));
        statAbilityDictionary[currentKey].setStatRequirements(currentKey);

        currentKey = generateAbilityKey(wisdomKeyChar);
		statAbilityDictionary.Add(currentKey, new StanceReapplicationAbility(CombatActionSettings.build(currentKey, DescriptionParams.build(battleMeditationName, useDescription: "Heal yourself and your allies, and spread your Stance to everyone within range."), DamageParams.build("W"), TargetParams.build(SelectorTemplate.BoxTwo, isSelfTargeting), FrequencyParams.build(oneSlotMax, eightRoundCooldown))));
        statAbilityDictionary[currentKey].setStatRequirements(currentKey);
		...
		// currentKey = generateAbilityKey(charismaKeyChar);
        // statAbilityDictionary.Add(currentKey, new Ability(CombatActionSettings.build(currentKey, DescriptionParams.build("Isolate", "Direct the flow of battle to sideline a single enemy. This enemy cannot act until it returns to the fray. Taking damage will remove this effect. Only one enemy can be isolated at a time. Costs 1 Red Knife stack and 1 Green Leaf stack."), TargetParams.build(SelectorTemplate.Single), FrequencyParams.build(oneSlotMax, fourRoundCooldown), CostParams.build(new ActionCostType[] { ActionCostType.RedKnife, ActionCostType.GreenLeaf }, new int[] { oneStackCastCost, oneStackCastCost }), TraitList.isolated)));
        // statAbilityDictionary[currentKey].setStatRequirements(currentKey);
...
// PurgeAbility 
	...
	private static void instantiateCompanionAbilities()
	{
        ...
        Ability standTogether = new Ability(CombatActionSettings.build(StatSourceNameList.standTogetherKey, DescriptionParams.build(StatSourceNameList.standTogetherKey, useDescription: "The caster calls for all of his allies to act as one. Allies in the area deal extra damage for the rest of Combat"), targetParams: TargetParams.build(SelectorTemplate.BoxThree, targetsOnlyAllies: true), frequencyParams: FrequencyParams.build(oneSlotMax, eightRoundCooldown), appliedTrait: TraitList.standTogether));
		...
		// listOfThatchAbilities.Add(new CompanionAttack(NPCNameList.thatch,"Backhanded Swing","TwoHandedPickReversed",SelectorTemplate.ReverseHookOne, "A swing of Thatch's pick in the opposite direction."));

		// listOfThatchAbilities.Add(new RepositionAllyAbility(CombatActionSettings.build(NPCNameList.thatch, DescriptionParams.build("Step Between", "Thatch shields an ally from harm, giving them time to reposition. Both Thatch and the target will take 75% less damage for two turns.", "Get Back!"), TargetParams.build(SelectorTemplate.Single), FrequencyParams.build(oneSlotMax, fourRoundCooldown), TraitList.stonewall)));

		//listOfThatchAbilities.Add(new Ability(CombatActionSettings.build(NPCNameList.thatch, DescriptionParams.build("Stonewall", "The caster and every ally within the caster's Zone of Influence take 75% less damage until the next turn. Best used early in the turn order. Has a long cooldown."), TargetParams.build(SelectorTemplate.Cross, isSelfTargeting), FrequencyParams.build(oneSlotMax, sevenRoundCooldown), TraitList.stonewall)));
        ...
        TraitBasedDamageAbility bouncingBlade = new TraitBasedDamageAbility(CombatActionSettings.build("Bouncing Blade", DescriptionParams.build("Bouncing Blade", useDescription: "The caster throws their blade, striking multiple targets in a line and dealing extra damage per additional trait applied to the target.", iconName: "BouncingBlade"), DamageParams.build("6D+W+C", "4D"), TargetParams.build(SelectorTemplate.VerticalThree), FrequencyParams.build(oneSlotMax, fiveRoundCooldown)), 0.25);
	...
	private static void instantiateSummonAbilities()
	{
        ...
        summonAbilityDictionary.Add(summonsWhipAttackKey, new Ability(CombatActionSettings.build(summonsWhipAttackKey, DescriptionParams.build("Punishment", useDescription: "A brutal show of whipwork, displayed by someone who has extensive experience with the tool.", iconName: "Lashings"), DamageParams.build("2+6C", "12C"), TargetParams.build(SelectorTemplate.VerticalThree))));
	}
