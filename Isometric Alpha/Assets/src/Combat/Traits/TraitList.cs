...
public static class TraitList
{
	...
	public static Trait exitStrategy = new ShieldTrait("Exit Strategy", protectionTraitType, "This creature and all of it's allies take 60% less damage until one round after the surprise round.", "ExitStrategy", oneRoundDuration, Color.black, exitStrategyDamageReduction); //exception to round duration rule because it's applied at the top of the first round and thus doesn't need to compensate for the first tick down.
