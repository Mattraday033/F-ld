...
public static class TraitList
{
	...
	public readonly static Trait riled = new StackableTrait(StatSourceNameList.riledKey, TraitType.Boost, "Provoked and ready to do something about it. This creature deals increased damage.", iconName: AbilityList.rileKey, startingStacks: Constants.oneStackAtStart, stacksAppliedPerApplication: Constants.oneStackPerApplication);
	...
	public readonly static Trait npcFlensed = new DamageOverTimeTrait(StatSourceNameList.flensedKey, TraitType.Wound, "This creature takes damage at the end of every round for the rest of combat.", "Flense", "7");
