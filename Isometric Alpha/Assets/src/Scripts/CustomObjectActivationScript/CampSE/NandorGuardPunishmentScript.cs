...
public class NandorGuardPunishmentScript : CustomObjectActivationScript
{
    public override bool evaluateScript()
    {
        if (Flags.getFlag(FlagNameList.nandorLeftParty) || Flags.getFlag(FlagNameList.spokeWithNandorAfterPrisoners))
        {
            return false;
        }
